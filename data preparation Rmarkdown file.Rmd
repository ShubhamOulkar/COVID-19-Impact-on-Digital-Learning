...
b<-read.csv("G:\\Covid-19 impact on Digital Learning\\Source data sets\\districts_info.csv")
...
a<-read.csv("G:\\Covid-19 impact on Digital Learning\\Source data sets\\state_rank_education.csv") 
c<-read.csv("G:\\Covid-19 impact on Digital Learning\\Source data sets\\close_date.csv")
...
p<-read.csv(("G:\\Covid-19 impact on Digital Learning\\Source data sets\\products_info.csv"),stringsAsFactors = T,na.strings = c(""))
...
engagement_list<-list.files("G:\\Covid-19 impact on Digital Learning\\engagement_data",
                            full.names = TRUE)
